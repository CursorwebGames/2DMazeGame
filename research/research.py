...
pygame.display.set_caption("Happy New Years!")
...
colors = [(0, 123, 255), (50, 0, 255), (255, 0, 255), (255, 0, 128), (221, 21, 21), (0, 255, 190), (0, 197, 36), (15, 105, 31), (255, 200, 0), (255, 109, 0)]
...
class Confetti:
    def __init__(self, x, y):
        ...
        self.sides, self.sizes = random.randint(MIN_SIDES, MAX_SIDES), random.randint(MIN_SIZE, MAX_SIZE)
...
# text
new_year = font.render("Happy 2023!", True, (255, 255, 255))
...
# draw
bg_color = (random.randint(125, 255), random.randint(125, 255), random.randint(125, 255))
count = 0
